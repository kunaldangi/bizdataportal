                ...
                <div className="user__content--perm">
                    ...
                    <div className="user__permUser">
                        ...
                        <div className="user__perm">
                            ...
                            <Switch switchId="id__permUser--manage" check={userInfo.permissions?.usersAcc?.manage} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>

                        <div className="user__perm">
                            <div className="user__perm--title">Manage User Account Permissions</div>
                            <Switch switchId="id__permUser--managePermissions" check={userInfo.permissions?.usersAcc?.managePermissions} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>

                        <div className="user__perm">
                            <div className="user__perm--title">Manage Whitelist</div>
                            <Switch switchId="id__permUser--manageWhitelist" check={userInfo.permissions?.usersAcc?.manageWhitelist} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>
                    </div>
                    ...
                    <div className="user__permTable">
                        ...
                        <div className="user__perm">
                            ...
                            <Switch switchId="id_permTable--create" check={userInfo.permissions?.tables?.create} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>

                        <div className="user__perm">
                            <div className="user__perm--title" id="">Read Tables</div>
                            <Switch switchId="id_permTable--read" check={userInfo.permissions?.tables?.read} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>

                        <div className="user__perm">
                            <div className="user__perm--title" id="">Write In Tables</div>
                            <Switch switchId="id_permTable--writeIn" check={userInfo.permissions?.tables?.writeIn} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>

                        <div className="user__perm">
                            <div className="user__perm--title" id="">Manage Tables</div>
                            <Switch switchId="id_permTable--manage" check={userInfo.permissions?.tables?.manage} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>

                        <div className="user__perm">
                            <div className="user__perm--title" id="">Manage Tables User Permissions</div>
                            <Switch switchId="id_permTable--manageUserPermissions" check={userInfo.permissions?.tables?.manageUserPermissions} disabled={!edit} switchClass="user__perm--switch" sliderClass="user__perm--slider user__perm--round" />
                        </div>
                    </div>
                </div>
            </div>
